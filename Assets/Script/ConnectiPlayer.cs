...
public class ConnectiPlayer : MonoBehaviour
{
    #region Variable
    ...
    public static ConnectiPlayer instance;
    [HideInInspector]
    public int Pontos;
    ...
    void Start()
    {
        ...
        {
            //  MyAvatar = PhotonNetwork.Instantiate(Path.Combine("Prefabs", "Personagens"), Vector3.zero, Quaternion.identity);
        }
